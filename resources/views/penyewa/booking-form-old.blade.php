        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('penyewa.booking.store') }}" method="POST">
                    ...
                    <!-- Step 1.5: Pilih Durasi (Hidden initially) -->
                    ...
                    <!-- Step 2: Pilih Tanggal (Hidden initially) -->
...
.package-card.selected .card-body {
    background: rgba(13, 110, 253, 0.05);
}
</style>
...
@push('scripts')
<script>
    const dailyRate = {{ $motor->rentalRate ? $motor->rentalRate->daily_rate : 0 }};
    const startDateInput = document.getElementById('start_date');
    const endDateInput = document.getElementById('end_date');
    const totalDaysDiv = document.getElementById('total-days');
    ...
    function calculateTotal() {
        ...
        if (startDate && endDate && endDate >= startDate) {
            ...
            totalDaysDiv.innerHTML = `<strong>${daysDiff} hari</strong>`;
            totalPriceDiv.innerHTML = `<strong class="text-primary">Rp ${new Intl.NumberFormat('id-ID').format(totalPrice)}</strong>`;
            
            submitBtn.disabled = false;
        } else {
            totalDaysDiv.innerHTML = '<span class="text-muted">Pilih tanggal terlebih dahulu</span>';
            totalPriceDiv.innerHTML = '<span class="text-muted">Pilih tanggal terlebih dahulu</span>';
