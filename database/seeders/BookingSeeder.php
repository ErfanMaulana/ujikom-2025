...
class BookingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $booking1 = Booking::create([
            'renter_id' => $penyewa1->id,
            'motor_id' => $motor1->id,
            'start_date' => Carbon::now()->subDays(10),
            'end_date' => Carbon::now()->subDays(7),
            'duration_type' => 'daily',
            'price' => 225000, // 3 hari x 75000
            'status' => 'completed',
        ...
        RevenueSharing::create([
            ...
            'total_amount' => 225000,
            'owner_amount' => 157500, // 70%
            'admin_commission' => 67500,  // 30%
        ]);

        // Booking 2 - Confirmed (Sedang Berlangsung)
        $booking2 = Booking::create([
            'renter_id' => $penyewa2->id,
            'motor_id' => $motor2->id,
            'start_date' => Carbon::now()->subDays(2),
            'end_date' => Carbon::now()->addDays(3),
            'duration_type' => 'daily',
            'price' => 475000, // 5 hari x 95000
            'status' => 'confirmed',
        ...
        RevenueSharing::create([
            ...
            'total_amount' => 475000,
            'owner_amount' => 332500, // 70%
            'admin_commission' => 142500,  // 30%
        ]);

        // Booking 3 - Pending (Menunggu Konfirmasi)
        $booking3 = Booking::create([
            'renter_id' => $penyewa3->id,
            'motor_id' => $motor3->id,
            'start_date' => Carbon::now()->addDays(1),
            'end_date' => Carbon::now()->addDays(3),
            'duration_type' => 'daily',
            'price' => 130000, // 2 hari x 65000
            'status' => 'pending',
        ...
        $booking4 = Booking::create([
            'renter_id' => $penyewa4->id,
            'motor_id' => $motor4->id,
            'start_date' => Carbon::now()->addDays(5),
            'end_date' => Carbon::now()->addDays(7),
            'duration_type' => 'daily',
            'price' => 160000, // 2 hari x 80000
            'status' => 'pending',
        ...
        RevenueSharing::create([
            ...
            'total_amount' => 130000,
            'owner_amount' => 91000,  // 70%
            'admin_commission' => 39000,   // 30%
        ]);
        ...
        $booking6 = Booking::create([
            ...
            'duration_type' => 'daily',
            'price' => 150000, // 2 hari x 75000
            'status' => 'cancelled',
            'notes' => 'Penyewa membatalkan karena ada perubahan rencana',
        ]);
